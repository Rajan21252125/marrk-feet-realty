                ...
                <div className="bg-white dark:bg-neutral-900 rounded-xl shadow-lg border border-gray-100 dark:border-white/5 p-4 mb-12 -mt-24 relative z-20 flex flex-col md:flex-row gap-4 items-center">
                    <div className="relative flex-1 w-full">
                        ...
                        <input
                            ...
                            className="w-full pl-12 pr-4 py-3 rounded-lg border border-gray-200 dark:border-white/10 bg-transparent focus:ring-2 focus:ring-accent focus:border-transparent outline-none transition-all text-gray-700 dark:text-gray-300"
                            value={filterQuery}
